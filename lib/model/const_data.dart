...
const String? chat1Image = 'https://images.pexels.com/photos/1308881/pexels-photo-1308881.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500';
const String? chat2Image = 'https://images.pexels.com/photos/1391498/pexels-photo-1391498.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500';
const String? myProfileImage = 'https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500';
const String? myProfileName = 'James';
...
List<BottomButtonData> bottomIconDataList = [
 BottomButtonData(FontAwesomeIcons.redoAlt,Colors.yellow),
 BottomButtonData(FontAwesomeIcons.times,Colors.redAccent),
 BottomButtonData(FontAwesomeIcons.solidStar,Colors.blue),
 BottomButtonData(FontAwesomeIcons.solidHeart,Colors.green),
 BottomButtonData(FontAwesomeIcons.bolt,Colors.purple),
];